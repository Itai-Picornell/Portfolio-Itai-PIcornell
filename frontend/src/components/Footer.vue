          ...
          <ul class="flex items-center gap-3" role="list">
            <li>
              <a
                ...
                class="p-2.5 rounded-lg text-gray-400 hover:text-gray-900 transition-colors duration-200"
                :aria-label="$t('footer.aria_github')"
              >
            ...
            <li>
              <a
                ...
                rel="noopener noreferrer"
                class="p-2.5 rounded-lg text-gray-400 hover:text-gray-900 transition-colors duration-200"
                :aria-label="$t('footer.aria_linkedin')"
              >
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a
                ...
                class="p-2.5 rounded-lg text-gray-400 hover:text-gray-900 transition-colors duration-200"
                :aria-label="$t('footer.aria_email')"
              >
